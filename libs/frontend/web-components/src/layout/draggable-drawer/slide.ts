export class SlideY {
    ...
    private pressed(
        ...
        this._handle.addEventListener('pointerup', this.onRelease, { passive: true });
        this._handle.addEventListener('pointercancel', this.onRelease, { passive: true });
        this._hostElement.addEventListener('mouseleave', this.onRelease, { passive: true });
    }
    ...
    private released(
        ...
        if (this.lastY !== null && this.lastTime !== null && this.startY !== null && this.startTime !== null) {
