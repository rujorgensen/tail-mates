...
export const WithHeaderAndFooter: Story = {
	args: {
		...
		mainContent:
			'This card demonstrates both header and footer slots working together.',
...
export const LargePadding: Story = {
	args: {
		...
		mainContent:
			'This card uses large padding for a more spacious appearance.',
...
export const RichContent: Story = {
    ...
    `;
		...
		footer.setAttribute('slot', 'footer');
		footer.innerHTML =
			'<button style="background: #3b82f6; color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer;">Send Friend Request</button>';
		card.appendChild(footer);
